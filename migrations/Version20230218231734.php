 ...
 */
final class Version20230218231734 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE user ADD seller_id INT NOT NULL');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D6498DE820D9 FOREIGN KEY (seller_id) REFERENCES seller (id) ON DELETE RESTRICT ');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP seller_id, CHANGE locale_id locale_id INT DEFAULT NULL');
