 ...
 */
final class Version20230213182820 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE INDEX IDX_ENTITY_ID ON file (entity_id)');
        $this->addSql('CREATE INDEX IDX_ENTITY_NAME ON file (entity_name)');
    }
