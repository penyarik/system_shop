 ...
 */
final class Version20230218183151 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE translation CHANGE description_product description_product LONGTEXT DEFAULT NULL, CHANGE name_product name_product VARCHAR(256) DEFAULT NULL, CHANGE description_category description_category LONGTEXT DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE translation CHANGE description_product description_product LONGTEXT NOT NULL, CHANGE description_category description_category LONGTEXT NOT NULL, CHANGE name_product name_product VARCHAR(256) NOT NULL');
