 ...
 */
final class Version20230219000320 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE user ADD currency INT(1) DEFAULT NULL');
        $this->addSql('CREATE INDEX INDEX_USER_CURRENCY ON user (currency)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX INDEX_USER_CURRENCY ON user');
        $this->addSql('ALTER TABLE user DROP currency, CHANGE seller_id seller_id INT DEFAULT 1 NOT NULL, CHANGE locale_id locale_id INT DEFAULT NULL');
