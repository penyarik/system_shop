 ...
 */
final class Version20230213180510 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product RENAME INDEX uniq_d34a04ad9caa2b25 TO UNIQ_PRODUCT_TRANSLATION');
